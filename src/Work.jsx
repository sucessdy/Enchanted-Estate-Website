  ...
  return (
    ...
    >
      <div className="bg-white  lg:p-16 p-6 mx-auto">
        <h1 className=" lg:py-4 md:py-3 sm:py-3  font-cinzel text-4xl md:text-3xl sm:text-2xl text-[#1d1d1c] ">
          {" "}
          Interior Design Vol.2
        </h1>
        <p className="para text-sm py-2 mx-auto p-4 m-3 mb-8 place-content-stretch">
          {" "}
        ...
        sm:text-xs border bg-[#1d1d1c]  p-2  h-12 w-1/2 ml-4  py-33 px-6    uppercase   "
          >
            {" "}
            Get in touch{" "}
          </button>
 ...
 "
        >
          <div className="  inline-flex my-2 mx-2 mt-6 py-3 flex-row">
            <h3 className="font-xl para  p-2 font-bold text-center ">
              {" "}
              Share:
            </h3>
            <a href="">
      ...
      <div className="max-w-[1000px] h-[500px]  w-full mx-auto relative  object-cover bg-white mb-12">
        <div
