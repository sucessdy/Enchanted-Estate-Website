...
>
    <h3 className="text-white font-black text-[40px]">"</h3>
     <motion.div key={index} variants={itemVariants} className="mt-1" >
      {" "}
      <p className="text-gray-200 para font-medium text-[18px]  ">
        {testimonial}
      </p>
      <div className="mt-7 flex justify-between items-center gap-1">
        <div className="flex flex-1 flex-col">
          <p className="text-gray-50 para ">
            {" "}
            <span className="blue-text-gradient"> @</span> {name}
          </p>

          <p className="mt-1 text-white text-[12px] para">
    ...
    <div className="testimonial bg-black-100 rounded-[20px] mt-4">
      <div className="bg-tertiary rounded-2xl min-h-[300px] p-20">
        <motion.div variants={textVariant()}>
          ...
          <h2 className="text-[28px] capitalize font-extrabold sm:text-[40px] mt-1 text-gray-200 font-BodoniModa leading-13">
            testimonials
          </h2>
        </motion.div>
      </div>
